...
interface BreadthFirstSearchVisualizationProps {
  isPlaying: boolean;
  onReset: () => void;
}
...
const BreadthFirstSearchVisualization: React.FC<BreadthFirstSearchVisualizationProps> = ({ isPlaying, onReset }) => {
  const [nodes, setNodes] = useState<GraphNode[]>([
    { id: 'A', x: 100, y: 100, visited: false, current: false, queue: false },
    { id: 'B', x: 200, y: 150, visited: false, current: false, queue: false },
    { id: 'C', x: 150, y: 200, visited: false, current: false, queue: false },
    { id: 'D', x: 300, y: 100, visited: false, current: false, queue: false },
    { id: 'E', x: 250, y: 250, visited: false, current: false, queue: false }
  ]);
  ...
  return (
    <div className="space-y-6">
      <div className="card">
        <h3 className="text-lg font-semibold mb-4">Breadth-First Search Visualization</h3>
        
        {/* Interactive Controls */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="space-y-2">
            <label className="text-sm font-medium">Start BFS</label>
            <button
              onClick={handleStep}
...
export default BreadthFirstSearchVisualization; 